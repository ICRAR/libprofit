...
# detection for UNIX & Win32
   ...
   # look for standalone Rmathlib
   find_library(LIBR_MATHLIB_LIBRARY NAMES Rmath
                HINTS ${LIBR_LIB_DIR} ${LIBRARY_ARCH_HINT_PATH} ${LIBR_HOME}/bin)
   if(LIBR_MATHLIB_LIBRARY)
     set(LIBR_LIBRARIES ${LIBR_MATHLIB_LIBRARY} ${LIBR_LIBRARIES})
     message(STATUS "Found Rmathlib: ${LIBR_MATHLIB_LIBRARY}")
   else()
     message(STATUS "Did not find Rmathlib.")
   endif()
